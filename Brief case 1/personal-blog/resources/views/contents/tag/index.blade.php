                                        ...
                                        <tr class="odd:bg-white even:bg-gray-50 border-b">
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex space-x-2">
                                                    <a href="{{ route('tag.edit', $val->id) }}" class="px-4 py-2 bg-yellow-600 rounded-md font-semibold text-xs text-white uppercase hover:bg-yellow-500">Edit</a>
                                                    <form action="{{ route('tag.destroy', $val->id) }}" method="post">
                                                    @csrf
                                                    @method('delete')
