        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('article.store') }}" class="space-y-6" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                        <div>
                        ...
                        <div>
                            ...
                            <img class="img-preview max-w-xs">
                            <x-text-input id="cover" name="cover" type="file" class="mt-1 block w-full" :value="old('cover')" required autocomplete="cover" onchange="previewImage()" accept="image/*" />
