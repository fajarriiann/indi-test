                ...
                <div class="p-6 text-gray-900">
                    ...
                    @method('put')
                        ...
                        <div class="mb-6 flex items-center">
                            ...
                            <input type="text" id="category" name="category" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" value="{{ $data->category }}" required>
                        </div>
                        <div class="mb-6 flex items-center">
                            <label for="price" class="w-1/3 block mb-2 text-sm font-medium text-gray-900">Harga <span class="text-red-500">*</span></label>
                            <input type="number" id="price" name="price" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" value="{{ $data->price }}" required>
                        </div>
