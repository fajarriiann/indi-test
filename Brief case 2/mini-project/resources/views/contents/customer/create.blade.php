                ...
                <div class="p-6 text-gray-900">
                    ...
                    @method('post')
                        ...
                        <div class="mb-6 flex items-center">
                            ...
                            <input type="text" id="domisili" name="domisili" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                        </div>
                        <div class="mb-6 flex items-center">
